...
public class AddBatchResult extends AppCompatActivity {
    ...
    private void saveData() {
        if (pdfUri != null) {
            ...
            if (!filename.isEmpty()) {
                ...
                StorageReference pdfRef = storageRef.child("Result/" + filename + ".pdf");
                ...
                uploadTask.addOnProgressListener(taskSnapshot -> {
                    ...
                    pdfRef.getDownloadUrl().addOnSuccessListener(uri -> {
                        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("Result");
