...
public class NSOStudents extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nsostudents);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Branch.equals("Branch")) {
                    ...
                    Toast.makeText(NSOStudents.this, "Select Branch", Toast.LENGTH_SHORT).show();
                } else if (Semester.equals("Sem")) {
                    tableLayout.removeViews(1, tableLayout.getChildCount() - 1);
                    Toast.makeText(NSOStudents.this, "Select Semester", Toast.LENGTH_SHORT).show();
                } else {
                    ProgressDialog progressDialog = new ProgressDialog(NSOStudents.this);
...
//                                            });
                                    ...
                                    if (!isDataFound) {
                                        Toast.makeText(NSOStudents.this, "Data not found", Toast.LENGTH_SHORT).show();
                                        cardView.setVisibility(View.GONE);
//                                        save.setVisibility(View.GONE);
                                        progressDialog.dismiss();
                                    }
                                } catch (Exception e) {
                                    Toast.makeText(NSOStudents.this, "Error", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(NSOStudents.this, "Student data not found", Toast.LENGTH_SHORT).show();
                                cardView.setVisibility(View.GONE);
//                                save.setVisibility(View.GONE);
                                progressDialog.dismiss();
                            }
...
//                }
//
//                Toast.makeText(NSOStudents.this, "Data saved successfully", Toast.LENGTH_SHORT).show();
//                progressDialog.dismiss();
//                finish();
//            }
//        });
