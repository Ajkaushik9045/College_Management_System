...
public class PrincipalStartAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_start_attendance);
        ...
        ProgressDialog progressDialog = new ProgressDialog(PrincipalStartAttendance.this);
                    ...
                    try {
                        ...
                        for (DataSnapshot dsp : snapshot.getChildren()) {
                            ...
                            if (BRANCH2.equals(branch) && SEMESTER2.equals(semester)) {
                                datanotfound = true;
                                TableRow row = new TableRow(PrincipalStartAttendance.this);
                                row.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.WRAP_CONTENT));

                                TextView viewName = new TextView(PrincipalStartAttendance.this);
                                viewName.setText(ROLLNO);
                                viewName.setTextSize(20);
                                viewName.setPadding(8, 8, 20, 8);
                                row.addView(viewName);

                                TextView viewID = new TextView(PrincipalStartAttendance.this);
                                viewID.setText(name);
                                ...
                                CheckBox checkBoxPresent = new CheckBox(PrincipalStartAttendance.this);
...
//                                if (differenceInDays <= 365 && differenceInDays >= -365) {
...
//                                } else {
//                                    progressDialog.dismiss();
//                                    Toast.makeText(PrincipalStartAttendance.this, "Choose a date within 1 Year of the current day.", Toast.LENGTH_SHORT).show();
//                                    finish();
//                                    return;
//                                }
                        ...
                        if (datanotfound == false) {
                            Toast.makeText(PrincipalStartAttendance.this, "Data not found", Toast.LENGTH_SHORT).show();
                            progressDialog.dismiss();
                            finish();
                        }
...
// Method to calculate the difference in days between two dates
        ...
        saveAttendanceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PrincipalStartAttendance.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        progressDialog1 = new ProgressDialog(PrincipalStartAttendance.this);
                            ...
                            studentRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    try {
                                        ...
                                        Toast.makeText(PrincipalStartAttendance.this, "Attendance saved successfully", Toast.LENGTH_SHORT).show();
                                        finish();
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                        progressDialog.dismiss();
                                        Toast.makeText(PrincipalStartAttendance.this, "Failed to save attendance", Toast.LENGTH_SHORT).show();
                                    }
                                }
                                ...
                                public void onCancelled(@NonNull DatabaseError databaseError) {
                                    // Handle onCancelled event
                                    Toast.makeText(PrincipalStartAttendance.this, "Database error occurred", Toast.LENGTH_SHORT).show();
                                }
                            });
                        } else {
                            Toast.makeText(PrincipalStartAttendance.this, "Invalid date or period", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
