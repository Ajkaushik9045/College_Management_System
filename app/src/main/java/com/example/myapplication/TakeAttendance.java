...
//        TeacherName.setText(TName);
        ...
        DatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(TakeAttendance.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Branch.equals("Branch")) {
                    Toast.makeText(TakeAttendance.this, "Select Branch", Toast.LENGTH_SHORT).show();
                } else if (Semester.equals("Sem")) {
                    Toast.makeText(TakeAttendance.this, "Select Semester", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(TakeAttendance.this, "Select Date", Toast.LENGTH_SHORT).show();
                } else {
...
//                                    Toast.makeText(TakeAttendance.this, "Select a valid Period", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(TakeAttendance.this, StartAttendance.class);
                    intent.putExtra(StartAttendance.BRANCH1, Branch);
                    intent.putExtra(StartAttendance.SEMESTER1, Semester);
                    intent.putExtra(StartAttendance.PERIOD1, Period);
                    intent.putExtra(StartAttendance.DATE1, Date);
                    intent.putExtra(StartAttendance.NAMES, Name);
                    intent.putExtra(StartAttendance.past1, previous1);
