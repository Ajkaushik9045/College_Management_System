...
public class PrincipalStudentRecord extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner Branchlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_student_record);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Branch.equals("Branch")) {
                    ...
                    Toast.makeText(PrincipalStudentRecord.this, "Select Branch", Toast.LENGTH_SHORT).show();
                } else if (Semester.equals("Sem")) {
                    tableLayout.removeViews(1, tableLayout.getChildCount() - 1);
                    Toast.makeText(PrincipalStudentRecord.this, "Select Semester", Toast.LENGTH_SHORT).show();
                } else {
                    ProgressDialog progressDialog = new ProgressDialog(PrincipalStudentRecord.this);
                                ...
                                try {
                                    for (DataSnapshot dsp : snapshot.getChildren()) {
                                        ...
                                        if (BRANCH.equals(Branch) && SEMESTER.equals(Semester)) {
                                            ...
                                            TableRow tableRow = new TableRow(PrincipalStudentRecord.this);
                                            tableRow.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, TableRow.LayoutParams.WRAP_CONTENT));

                                            TextView snumber = new TextView(PrincipalStudentRecord.this);
                                            snumber.setText(String.valueOf(sno));
                                            snumber.setPadding(8, 8, 8, 8);
                                            tableRow.addView(snumber);

                                            TextView ViewName = new TextView(PrincipalStudentRecord.this);
                                            ViewName.setText(ROLLNO);
                                            ViewName.setPadding(8, 8, 8, 8);
                                            tableRow.addView(ViewName);


                                            TextView ViewID = new TextView(PrincipalStudentRecord.this);
                                            ViewID.setText(NAME);
...
//                                            tableRow.addView(ViewPassword);
                                            ...
                                            CheckBox checkBoxPresent = new CheckBox(PrincipalStudentRecord.this);
                                    ...
                                    if (!isDataFound) {
                                        Toast.makeText(PrincipalStudentRecord.this, "Data not found", Toast.LENGTH_SHORT).show();
                                        cardView.setVisibility(View.GONE);
                                        progressDialog.dismiss();
                                    }
                                } catch (Exception e) {
                                    cardView.setVisibility(View.GONE);
                                    progressDialog.dismiss();
                                    Toast.makeText(PrincipalStudentRecord.this, "Error", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(PrincipalStudentRecord.this, "Student data not found", Toast.LENGTH_SHORT).show();
                                cardView.setVisibility(View.GONE);
                                progressDialog.dismiss();
                                save.setVisibility(View.GONE);
                            }
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(PrincipalStudentRecord.this, "Data saved successfully", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
                finish();
            }
        });
